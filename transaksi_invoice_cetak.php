...
<html>
<head>
<title>Sistem Informasi Konveksi Abstract Project - WWW.ABSTRACTPROJECT.COM</title>
...
<tr>
<th>Banyak Pakaian (pcs)</th>
<th>:</th>
<td><?php echo $t['transaksi_banyak']; ?></td>
</tr>
<tr>
<th>Tgl. Selesai</th>
<th>:</th>
...
echo "<div class='label label-warning'>MENUNGGU</div>";
}else if($t['transaksi_status']=="1"){
echo "<div class='label label-info'>DIKERJAKAN</div>";
...
<br/>
<p><center><i>" Terima kasih telah mempercayakan kepada kami ".</i></center></p>
<?php 
}
?>
</div>
